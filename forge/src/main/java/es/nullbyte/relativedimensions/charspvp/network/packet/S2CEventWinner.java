...
public class S2CEventWinner {
    ...
    public void handle(CustomPayloadEvent.Context ctx) {
        ...
        es.nullbyte.relativedimensions.charspvp.GUI.LocalTimeState.winner = winnername;
        es.nullbyte.relativedimensions.charspvp.GUI.LocalTimeState.winnerid = winneruuid;
