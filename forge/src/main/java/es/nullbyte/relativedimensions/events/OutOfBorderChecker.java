            ...
            if (event.phase == TickEvent.Phase.END && !player.isSpectator()) {
                ...
                if (!worldBorder.isWithinBounds(playerPos)) {
                    ...
                    if (playerbrdrtick == 0) {
                        ...
                        player.sendSystemMessage(Component.translatable("system.worldborder.outofbounds",warningTimeInSeconds-playerbrdrseconds));
                    } else {
                        playerbrdrtick++;
                        if (playerbrdrtick % 20 == 0) {
                            ...
                            player.sendSystemMessage(Component.translatable("system.worldborder.tpback"));
