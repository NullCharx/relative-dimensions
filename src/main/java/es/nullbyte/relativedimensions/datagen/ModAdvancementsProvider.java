...
public class ModAdvancementsProvider implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
        ...
        AdvancementHolder aberrant_tool_made = Advancement.Builder.advancement()
                ...
                .addCriterion("has_aberrant_tool", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ABERRANT_AXE.get(), ModItems.ABERRANT_SWORD.get(), ModItems.ABERRANT_PICK.get()))
        ...
        AdvancementHolder teleportation_root = Advancement.Builder.advancement()
                .display(new DisplayInfo(new ItemStack(ModItems.AVID_SDPT.get()),
                ...
                .addCriterion("has_avidsdpt", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.AVID_SDPT.get()))
