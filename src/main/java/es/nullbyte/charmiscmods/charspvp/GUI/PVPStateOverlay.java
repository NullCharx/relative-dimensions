...
public class PVPStateOverlay{
    ...
    public static final IGuiOverlay PVP_STATE_HUD = ((forgeGui, guiGraphics, partialTick, width, height) -> {
        ...
        // Draw "HH:MM:SS" text
        long timer = es.nullbyte.charmiscmods.charspvp.timenpvpstate.GUI.LocalTimeState.localtimers.get(Minecraft.getInstance().player.getUUID());
        ...
        int intstate = es.nullbyte.charmiscmods.charspvp.timenpvpstate.GUI.LocalTimeState.PVPstate;
