...
public class RegistrySetBuilder {
    ...
    private <T> HolderLookup.RegistryLookup<T> createLazyFullPatchedRegistries(
            HolderOwner<T> p_312548_, Cloner.Factory p_312934_, ResourceKey<? extends Registry<? extends T>> p_313093_,
            HolderLookup.Provider p_311682_, HolderLookup.Provider p_313198_, MutableObject<HolderLookup.Provider> p_311605_
    ) {
        ...
        if (cloner == null) {
            ...
            if (optional.isPresent()) {
                ...
                lifecycle = lifecycle.add(registrylookup1.registryLifecycle());
            }
